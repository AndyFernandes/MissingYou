...
import br.ufc.missingyou.view.activitys.QuadroCampanhasCadastradas;
import br.ufc.missingyou.view.activitys.QuadroCampanhasSalvas;

public class CustomListAdapteSalvas extends BaseAdapter {
    ...
    public CustomListAdapteSalvas(FragmentActivity activity, List<Quadro> quadros) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, QuadroCampanhasSalvas.class);
