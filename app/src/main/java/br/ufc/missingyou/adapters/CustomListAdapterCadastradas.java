...
public class CustomListAdapterCadastradas extends BaseAdapter {
    ...
    public CustomListAdapterCadastradas(FragmentActivity activity, List<Quadro> quadros) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, QuadroCampanhasCadastradas.class);
