...
import br.ufc.missingyou.adapters.CustomListAdapteSalvas;
import br.ufc.missingyou.adapters.CustomListAdapter;
import br.ufc.missingyou.adapters.CustomListAdapterCadastradas;
...
public class FeedCampanhasSalvas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CustomListAdapteSalvas adapter = new CustomListAdapteSalvas(getActivity(), quadros);
